	...
	return (
		...
		>
			{layers.map((layer, index) => (
				<TileLayer key={`${mapType}-${index}`} attribution={layer.attribution} url={layer.url} />
			))}
			...
			{/* Рисуемая зона */}
			{isDrawingZone && drawingCoordinates.length > 0 && <DrawingLayer coordinates={drawingCoordinates} />}
